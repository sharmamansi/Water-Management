...
export default function Updatenode() {
    ...
    const submit = async (e) => {
        ...
        try{
         ...
         var hasrecievingl = await Axios.put("http://localhost:5000/nodes/update/recievepoints",cred);
         if(!hasrecievingl){
        ...
        var hassupplyingl = await Axios.put("http://localhost:5000/nodes/update/supplypoints",cred);
        if(!hassupplyingl){
        ...
        var hassupplyobj = await Axios.put("http://localhost:5000/nodes/update/supplyobj",cred);
        if(!hassupplyobj){
        ...
        var hasrecieveobj = await Axios.put("http://localhost:5000/nodes/update/recieveobj",cred);
        if(!hasrecieveobj){
...
<input id="customer_id" type="text"  onChange={(e) => setId(e.target.value)}  />
</div>
<h5>Add Distribution/Supply Points</h5>
<br/>
<div className="input-feild">
<label htmlFor="recievingl">Enter Recieving points</label>
    <input id="recievingl" type="text"  onChange={(e) => setRecievingl(e.target.value)} />
</div>
<div className="input-feild">
<label htmlFor="supplyingl">Enter Supply Points</label>
<input id="supplyingl" type="text"  onChange={(e) => setSupplyingl(e.target.value)}/>
</div>
 </form>
</div>
...
<input id="sportname" type="text" onChange={(e) => setSportname(e.target.value)} />
</div>
<div className="input-feild">
<label htmlFor="squantity">Supplied quantity</label>
<input id="squantity" text="text" onChange={(e) => setSquantity(e.target.value)}/>
</div>
<div className="input-feild">
<label htmlFor="smonth">Supply month</label>
<input id="smonth" type="text" onChange={(e) => setSmonth(e.target.value)}/>
</div>
<div className="input-feild">
<label htmlFor="syear">Supply year</label>
<input id="syear" type="text" onChange={(e) => setSyear(e.target.value)}/>
</div>
 </form>
</div>
...
<form>
<div className="input-feild">
<label htmlFor="rportname">  Recieved From Id</label>
<input id="rportname" type="text" onChange={(e) => setRportname(e.target.value)} />
</div>
<div className="input-feild">
<label htmlFor="rquantity">Recieved quantity</label>
<input id="rquantity" text="text" onChange={(e) => setRquantity(e.target.value)}/>
</div>
<div className="input-feild">
<label htmlFor="rmonth">Recieved month</label>
<input id="rmonth" type="text" onChange={(e) => setRmonth(e.target.value)}/>
</div>
<div className="input-feild">
<label htmlFor="ryear">Recieved year</label>
<input id="ryear" type="text" onChange={(e) => setRyear(e.target.value)}/>
</div>
 </form>
</div>
